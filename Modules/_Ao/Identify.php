...
The Class itself...
*/
class Identify extends \Commodities\BaseActiveModule
{
    ...
    public function identify_item($low, $high, $ql)
    {
        ...
        case 274208:
            $purpose
                = "Random Gift: Candy Cane, Double Candy Canes, The Naughty List Bikini Top/Bottom/Boxers, Gingerbread Man/Woman/Heart, Santa Leet Doll, Gingerbread House, Snowman";
            break;
        case 274209:
            $purpose
                = "Random Gift: Candy Cane, Double Candy Canes, The Naughty List Bikini Top/Bottom/Boxers, Gingerbread Man/Woman/Heart, Santa Leet Doll, Gingerbread House, Snowman";
