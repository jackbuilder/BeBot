...
The Class itself...
*/
class TowerAttack extends \Commodities\BaseActiveModule
{
    ...
    */
    ...
    public function get_lcainfo($zone, $x, $y)
    {
    ...
    public function format_attack_string($infos, $string, $victory = false)
    {
        if ($victory) {
            $infos["lca_num"] = "";
            $infos["lca_name"] = "";
    ...
    public function relay_tower_damage(
