...
class Quotes extends \Commodities\BaseActiveModule
{
    ...
    public function add_quote($strquote, $name)
    {
    ...
    public function del_quote($qnum, $name)
    {
    ...
    public function send_quote($qnum)
    {
        $strquote = "";
        if ($qnum == -1) {
            $num = $this->bot->db->select("SELECT id FROM #___quotes ORDER BY id DESC");
    ...
    public function search_quote($qtext)
    {
        $strquote = "";
