...
class Conf
{
    ...
    public function __construct($argv, $confc)
    {
        $this->confc = $confc;
        $this->argv = $argv[1];
        $this->check($argv);
    ...
    public function load($argv = FALSE)
    {
    ...
    public function check($argv = FALSE)
    {
        if (!isset($this->cf)) {
    ...
    public function todo($rep = FALSE)
    {
        if (!$rep) {
...
?>';
    ...
    public function mysql_todo($botname, $rep = FALSE)
    {
        if (!$rep) {
    ...
    public function mysql_set_conf($botname)
    {
